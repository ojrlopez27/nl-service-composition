...
public class NERDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        AbstractSequenceClassifier<CoreLabel> classifier = new NERClassifierCombiner(serializedClassifier);//CRFClassifier.getClassifier(serializedClassifier);
    ...
    */
      ...
      */
            ...
            String[] example = {"Good afternoon Rajat Raina, how are you today?",
                    ...
                    "Check calendar availability from August 3 to August 8"};
