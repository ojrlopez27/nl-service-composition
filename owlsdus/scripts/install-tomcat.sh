...
# Change the Tomcat default ports
sed -i -e 's/8080/9090/g' $TOMCAT_CONFIG
sed -i -e 's/8009/9009/g' $TOMCAT_CONFIG
sed -i -e 's/8443/9443/g' $TOMCAT_CONFIG
...
echo "Tomcat configurations complete. Ready to use."
