...
import edu.cmu.inmind.services.pojos.RestaurantPOJO;
import java.util.Date;

import static edu.cmu.inmind.services.apis.BookRestaurantService.SERVICE;
...
public interface BookRestaurantService extends GenericService {
    ...
    String SERVICE = "BookRestaurantService";
