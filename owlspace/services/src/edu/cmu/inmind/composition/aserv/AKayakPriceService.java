...
public class AKayakPriceService {

    /**
     * This method allows to get the price of the hotel from Kayak.com 
    ...
    public Long hotelPrice(String hotelName) {
        Log4J.warn(this, String.format("Executing AKayakPriceService.hotelPrice for: "
